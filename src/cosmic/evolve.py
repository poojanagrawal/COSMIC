        ...
        **kwargs:
        ...
        if SSEDict:
            if SSEDict['stellar_engine'] == 'metisse':
                ...
                # PA: not true for also not working currently, can be fixed and removed
                ...
                _ = read_tracks_for_METISSE(SSEDict['path_to_tracks'],IBT_Z=initialbinarytable['metallicity'].iloc[0],is_he=False)
                                            
                if (SSEDict['path_to_he_tracks'] != ''):
                    _ = read_tracks_for_METISSE(SSEDict['path_to_he_tracks', IBT_Z=initialbinarytable['metallicity'].iloc[0], is_he=True]
...
def read_tracks_for_METISSE(path_to_tracks,IBT_Z,is_he):
...
#       PA: what about Z_accuracy_limit?; can be used here
